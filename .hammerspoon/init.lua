...
hs.hotkey.bind(super, hs.keycodes.map["\""], function() yabai({"-m", "space", "mouse", "--layout", "bsp"}, function() toast("🖖") end) end)  --["1"]
hs.hotkey.bind(super, hs.keycodes.map["«"], function() yabai({"-m", "space", "mouse", "--layout", "stack"}, function() toast("📚") end) end)  --["2"]
hs.hotkey.bind(super, hs.keycodes.map["»"], function() yabai({"-m", "space", "mouse", "--layout", "float"}, function() toast("☁️") end) end)  --["3"]
...
hs.hotkey.bind(super, hs.keycodes.map["è"], function() yabai({"-m", "window", "--focus", "stack.next"}, function() toast("📚↥") end) end)  --["t"]
hs.hotkey.bind(super, hs.keycodes.map[","], function() yabai({"-m", "window", "--focus", "stack.prev"}, function() toast("📚↧") end) end)  --["g"]
